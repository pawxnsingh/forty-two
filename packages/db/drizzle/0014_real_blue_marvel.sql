...
ALTER TABLE "analysis_artifacts" ADD CONSTRAINT "analysis_artifacts_id_format_check" CHECK ("analysis_artifacts"."id" ~ '^art_[0-7][0-9A-HJKMNP-TV-Z]{25}$');--> statement-breakpoint
